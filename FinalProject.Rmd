...
1. **What speed zones result in the most crashes?**
   - We will investigate if different speed limits affect the amount of crashes that are in the area, and how severe they are.

2. **What car type is most commonly found in car crashes?**
   - We will compare the different types of vehicles (SUV, sedan, etc) and see which cars are safer (In less crashes).

3. **Is there a higher injury rate correlated with substance abuse??**
   - We will see DUI's have a correlation with more severe injuries.


4. **What factor correlates most with crash severity?**
    - We will investigate which of the many factors involved in crashes leads to higher rates of severe injuries
